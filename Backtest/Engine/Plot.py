...
class Plot(object):
    ...
    def plot_equity(self):
        ...
        :return:
        """
        data = pd.read_csv(self.csv_dir + '/ResultData/Equity_' + self.strategy_id + '.csv', header=0, parse_dates=True,
                           index_col=0)
        fig = plt.figure()
        ...
        plt.grid(True)
        image='C:\\Users\\cspet\\\Documents\\QMAFX\\ForexWeb\\static\\img\\'+self.strategy_id+'.png'
        plt.savefig('C:\\Users\\cspet\\\Documents\\QMAFX\\ForexWeb\\static\\img\\'+self.strategy_id+'.png')
