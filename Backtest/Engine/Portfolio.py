...
import pandas as pd
import numpy as np
from Enum import OrderStatus, OrderType
from Enum import EventType
from EventEngine import OrderSendEvent, OrderModifyEvent, OrderCloseEvent
import pprint
from Error import EquityError
...
class Portfolio(object):
    ...
    def output_equity(self):
        ...
        :return:
        """
        self.equity.to_csv(self.csv_dir + '/ResultData/Equity_%s.csv' % (self.strategy_id))
        self.order.to_csv(self.csv_dir + '/ResultData/Order_%s.csv' % (self.strategy_id))
